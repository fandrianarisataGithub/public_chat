<template>
	<div class="page-inbox">
		<div class="mail-box">
			<aside class="sm-side nav-side scrollbar">
				<div class="user-head d-flex justify-content-between">
					<div class="profile">
								...
								<div class="modal-body">
									<form role="form" class="form-horizontal">
										...
										<div class="form-group">
											...
											>
												<span
													class="btn green fileinput-button"
												>
													<i
				...
				<ul class="nav nav-pills nav-stacked labels-info inbox-divider d-flex flex-column section-nav-aside">
					<li><h4>Labels</h4></li>
					<li>
						<a href="#">
							<i class="fa fa-sign-blank text-danger"></i> Work
						</a>
					</li>
					<li>
						<a href="#">
							<i class="fa fa-sign-blank text-success"></i> Design
						</a>
					</li>
					<li>
						<a href="#">
							<i class="fa fa-sign-blank text-info"></i> Family
						</a>
					</li>
					<li>
						<a href="#">
							<i class="fa fa-sign-blank text-warning"></i>
							Friends
						</a>
					</li>
					<li>
						<a href="#">
							<i class="fa fa-sign-blank text-primary"></i> Office
						</a>
					</li>
				</ul>
				<ul class="nav nav-pills nav-stacked labels-info d-flex flex-column section-nav-aside">
					<li><h4>Buddy online</h4></li>
					<li>
						<a href="#">
							<i class="fa fa-circle text-success"></i>Alireza
							Zare
							<p>I do not think</p></a
						>
					</li>
					<li>
						<a href="#">
							<i class="fa fa-circle text-danger"></i>Dark Coders
							<p>Busy with coding</p></a
						>
					</li>
					<li>
						<a href="#">
							<i class="fa fa-circle text-muted"></i>Mentaalist
							<p>I out of control</p></a
						>
					</li>
					<li>
						<a href="#">
			...
			<aside class="lg-side">
				<div class="inbox-head d-flex justify-content-between">
					<h3>Inbox</h3>
					...
					<div class="mail-option">
						...
						<ul class="unstyled inbox-pagination">
							...
							<li>
								<a class="np-btn" href="#"
									><i
										class="fa fa-angle-left pagination-left"
									></i
								></a>
							</li>
							<li>
